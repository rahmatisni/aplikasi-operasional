			...
			<div class="modal-body">
				<form id="form-tambah-edit-blacklist" id="form-tambah-edit-blacklist">
					...
					<div class="form-group">						
						...
						<input type="text" class="form-control" name="uuid" id="uuid" aria-describedby="blacklist" placeholder="UUID" required>
					</div>
                    <div class="form-group">						
						<label for="exampleInputEmail1">Info :</label>
						<input type="text" class="form-control" name="info" id="info" aria-describedby="info" placeholder="Info Blacklist" required>
					</div>
                    <div class="form-group">						
						<label for="exampleInputEmail1">Tick :</label>
						<input type="text" class="form-control" name="tick" id="tick" aria-describedby="tick" placeholder="Tick Blacklist" required>
					</div>						
