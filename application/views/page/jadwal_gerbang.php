            ...
            <div class="panel panel-default">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                                    ...
                                    <select class="form-control" id="jenis" name="jenis" onchange="getDataPetugasByChange()">
                                        <option selected value="1">PLT</option>
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin:20px 0px;">
                        ...
                        <div class="col-xs-2">   
                            <button id="btnTulis" type="submit" class="btn btn-block btn-primary">Transfer Jadwal</button>
                        </div>
                        <div class="col-xs-2"> 
                            <button id="btnReset" type="button" class="btn btn-block btn-danger">Rencanakan Lagi</button>
                        </div>
                        <div class="col-xs-4">  
                        </div>
                    </div>
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-body">
				<form id="form-tambah-edit-rencana" id="form-tambah-edit-rencana">
                    ...
                    <div class="form-group">
                        <input type="true" name="mgerbang" id="mgerbang"/>
                        <input type="true" name="mjenis" id="mjenis"/>						
						<input type="true" name="id" id="id"/>
                    ...
                    <div class="form-group">				
                     ...
                     <div class="form-group">						
                        ...
                        <select class="form-control gerbang_penempatan" style="width:100%;" name="mshift">
                        <?php 
