    ...
    <!-- <div class="row">
        <div class="col-xs-12 col-md-4">
            <div class="panel panel-default panel-widget">
                ...
                <span class="panel-title  text-black"><i class="fa fa-fw fa-users"></i> Tools Pembuatan Kartu Dinas</span>
...
<div class="modal fade" id="kartuOperasionalModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    $( document ).ready(function() {
        ...
        $("#btnTulis").click(function(){
            var uid='';
            $.ajax({
                url:"http://127.0.0.1:2929/read/uid",
                method:"GET",                            
                success:function(response)
                {                       
            ...
            if(uid =='')
            {
                console.log('Simpan UID di database');
                Swal.fire({
                title: 'Menulis Data di KTP?',
                text: "Klik Ok untuk Melanjutkan",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Yes, OK Lanjutkan!'
                }).then((result) => {
